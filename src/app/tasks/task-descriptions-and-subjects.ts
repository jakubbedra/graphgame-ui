export class TaskDescriptionsAndSubjects {
  ...
  public static DESCRIPTIONS: Record<string, string> = {
    ...
    CHINESE_POSTMAN_PROBLEM_EDGE_SELECTION: "Select an optimal route through all the edges.",
    ...
    EDGE_COLORING_EDGE_COLORING: "Color the edges of the given graph (sub)optimally, so that they have exactly $\\Delta (G)$ or $\\Delta (G) + 1$ colors.",
	  ...
	  BIPARTITE_GRAPHS_VERTEX_COLORING: "Color the vertices of the given bipartite graph optimally.",
	  BIPARTITE_GRAPHS_EDGE_COLORING: "Color the edges of the given bipartite graph (sub)optimally.",
